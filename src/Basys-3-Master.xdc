...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports {DIG4[3]}]
...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {DIO}]
set_property IOSTANDARD LVCMOS33 [get_ports {DIO}]
set_property PULLUP TRUE [get_ports {DIO}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {ECH}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ECH}]
##Sch name = JA3
